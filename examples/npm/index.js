...
const svgLineBottomLeft = document.querySelector('.line-chart-bottom-left');
new chartXkcd.Line(svgLineBottomLeft, {
...
const svgLineBottomRight = document.querySelector('.line-chart-bottom-right');
new chartXkcd.Line(svgLineBottomRight, {
